...
/*// Connexion en externe 
    ...
    //pour liberer de la place pour que qqun d'autre puisse se connecter.Ramasseur de miettes il detruit tt ce qui prend de la place apres execution du programme.
    {
        PdoGsb::$monPdo = null;
    }
...
/**
     ...
     */
     public function getTotalLesFrais($idVisiteur,$leMois){
        $requetePrepare = PdoGsb::$monPdo->prepare(
...
/**
     ...
     */
     public function getTotalLesHorsFrais($idVisiteur,$leMois){
        $requetePrepare = PdoGsb::$monPdo->prepare(
     ...
     * un mois donné en enregistrant les nouveaux montants
     *
     * @param String $dateFrais Date du hors forfait sous la forme aaaamm
     * @param String $libelle    Motif du frais
     * @param Array  $montant   Prix du frais
     *
     * @return null
     */
    
    
    public function majFraisHorsForfait($idVisiteur, $leMois, $dateHF1, $libelleHF, $montantHF)
    {
