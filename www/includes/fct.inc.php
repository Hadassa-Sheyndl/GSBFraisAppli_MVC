...
function estConnecteV()
{
    ...
    //isset : s'il y a qqch dans la colonne idVisiteur du tableau session 
    // renvoie tjr un booleen 
}

function estConnecteC()
{
    return isset($_SESSION['idComptable']);
    //isset : s'il y a qqch dans la colonne idComptable du tableau session 
    // renvoie tjr un booleen 
}
...
function getDouzeDernierMois($mois){
    $lesMois = array();
    for ($k = 0; $k <= 12; $k++) {
